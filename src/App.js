...
function App() {
  ...
  return (
    <div className="App">
      ...
      당신의 소중한 기념일을 더욱 특별하게 해줄 오리지널비어컴퍼니의 커스텀 수제 맥주를 만나보세요. 내 취향에 맞는 맥주 레시피와 나만의 스토리를 담은 라벨까지, 세상에 단 하나뿐인 맥주로 잊지 못할 추억을 선사해드립니다.
      <br/>

      <b>나만의 취향을 가득 담은 맥주</b>
      <br/>

      오리지널비어컴퍼니만의 제조 노하우를 활용해 당신의 섬세한 취향에 맞춘 맥주 레시피를 제안해드립니다.
      ...
      나만의 스토리를 담은 맥주 네이밍부터 라벨 디자인까지 나만의 스페셜 에디션 수제맥주 제작이 가능합니다.
      ...
      우리의 맥주를 경험하는 모든 순간에
      탁월함을 느낄 수 있기를 바랍니다.
      코르크 마개를 개봉하는 순간부터 맥주 본연의 깊은 맛과 풍미를 음미하기까지 모든 순간에 세심한 손길을 더했습니다


      <b>특별한 순간의 기록</b>
      당신의 특별한 순간을 기념할 때 
      우리의 맥주와 함께 더 큰 행복을 느끼시기를 
      바랍니다. 우리의 맥주는 기념하고 싶은 당신의 특별한 순간을 
      더욱 선명하고 빛나게 기획해드릴 것입니다.
